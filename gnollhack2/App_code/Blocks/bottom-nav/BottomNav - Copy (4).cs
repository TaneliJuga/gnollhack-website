...
//            public IEnumerable<KeyValuePair<int, int>> Cols { get; }
...
//                    Cols = MakeCol(ColCounts, ColWidths);
//                    return;
//                }
...
//            private IEnumerable<KeyValuePair<int, int>> MakeCol(int[] colCounts, int[] colWidths)
//            {
...
//                {
//                    res.Add(new KeyValuePair<int, int>(colCounts[i], colWidths[i]));
//                }
